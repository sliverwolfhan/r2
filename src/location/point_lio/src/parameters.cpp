...
void readParameters(std::shared_ptr<rclcpp::Node> & nh)
{
  ...
  try {
    ...
    nh->declare_parameter<bool>("preprocess.body_filter_en", false);
    nh->get_parameter("preprocess.body_filter_en", p_pre->body_filter_en);

    nh->declare_parameter<double>("preprocess.body_min_x", -0.3);
    nh->get_parameter("preprocess.body_min_x", p_pre->body_min_x);

    nh->declare_parameter<double>("preprocess.body_max_x", 0.3);
    nh->get_parameter("preprocess.body_max_x", p_pre->body_max_x);

    nh->declare_parameter<double>("preprocess.body_min_y", -0.3);
    nh->get_parameter("preprocess.body_min_y", p_pre->body_min_y);

    nh->declare_parameter<double>("preprocess.body_max_y", 0.3);
    nh->get_parameter("preprocess.body_max_y", p_pre->body_max_y);

    nh->declare_parameter<double>("preprocess.body_min_z", -0.5);
    nh->get_parameter("preprocess.body_min_z", p_pre->body_min_z);

    nh->declare_parameter<double>("preprocess.body_max_z", 0.3);
    nh->get_parameter("preprocess.body_max_z", p_pre->body_max_z);
