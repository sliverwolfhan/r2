...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  bool body_filter_en;
  double body_min_x, body_max_x;
  double body_min_y, body_max_y;
  double body_min_z, body_max_z;
  ...
  // Body filter helper function
  bool is_in_body_box(double x, double y, double z);
