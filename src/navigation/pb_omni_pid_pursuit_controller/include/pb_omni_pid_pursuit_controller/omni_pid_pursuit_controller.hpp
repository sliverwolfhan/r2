...
private:
  ...
  std::shared_ptr<PID> move_pid_x_;
  std::shared_ptr<PID> move_pid_y_;
  std::shared_ptr<PID> heading_pid_;

  // Controller parameters
  double translation_x_kp_, translation_x_ki_, translation_x_kd_;
  double translation_y_kp_, translation_y_ki_, translation_y_kd_;
  ...
  double yaw_alignment_threshold_;
  double yaw_full_suppress_angle_;
