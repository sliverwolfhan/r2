...
def generate_launch_description():
    """
    红区竞技赛(单项赛) 抓武器头 launch。

    只抓一个武器头(weapon_priority 列表第一个), 默认行为树 grasp_head_red_match.xml:
      ros2 launch at_r2_bt r2_bt_launch_red_match.py
      ros2 launch at_r2_bt r2_bt_launch_red_match.py bt_xml:=grasp_head_red_match.xml
    """
