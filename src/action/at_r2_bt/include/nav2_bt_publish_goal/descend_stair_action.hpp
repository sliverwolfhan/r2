...
#ifndef NAV2_BT_PUBLISH_GOAL__DESCEND_STAIR_ACTION_HPP_
#define NAV2_BT_PUBLISH_GOAL__DESCEND_STAIR_ACTION_HPP_
...
class DescendStairAction : public BT::StatefulActionNode
{
public:
  DescendStairAction(
...
private:
  ...
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr descend_pub_;
  ...
  // Status constants
  static constexpr int32_t STATUS_DESCENDING = 1;
  ...
  // ===== 下台阶期间的朝向纠偏（只发 angular.z）=====
  // 目标朝向取自下台阶前的准备朝向 (target_yaw / prep_yaw)，
...
#endif  // NAV2_BT_PUBLISH_GOAL__DESCEND_STAIR_ACTION_HPP_
